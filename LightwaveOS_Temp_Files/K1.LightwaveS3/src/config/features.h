...
// Hub/Node Wireless Architecture (NEW)
// When enabled: K1 acts as a Node runtime controlled by Tab5 Hub
// When disabled: K1 runs standalone with local controls (encoder/web/serial)
#ifndef FEATURE_NODE_RUNTIME
#define FEATURE_NODE_RUNTIME 1
#endif
