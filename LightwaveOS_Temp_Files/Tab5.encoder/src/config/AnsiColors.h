...
// Tab5 top-level tags (human-facing)
#define COLOR_HUB          ANSI_BRIGHT_CYAN
#define COLOR_ENC          ANSI_BRIGHT_GREEN
#define COLOR_LVGL         ANSI_BRIGHT_MAGENTA
#define COLOR_PARAM        ANSI_BRIGHT_BLUE
...
#define LOG_HUB(fmt, ...)         Serial.printf(COLOR_HUB "[HUB]" ANSI_RESET " " fmt "\n", ##__VA_ARGS__)
#define LOG_ENC(fmt, ...)         Serial.printf(COLOR_ENC "[ENC]" ANSI_RESET " " fmt "\n", ##__VA_ARGS__)
#define LOG_LVGL(fmt, ...)        Serial.printf(COLOR_LVGL "[LVGL]" ANSI_RESET " " fmt "\n", ##__VA_ARGS__)
#define LOG_PARAM(fmt, ...)       Serial.printf(COLOR_PARAM "[Param]" ANSI_RESET " " fmt "\n", ##__VA_ARGS__)
