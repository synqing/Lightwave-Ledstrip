...
//
// ARCHITECTURE FLIP: Tab5 is now HUB (SoftAP host), not client
// ENABLE_WIFI = 1 for Hub SoftAP mode
// ENABLE_LEGACY_WIFI_CLIENT = 0 to disable old client infrastructure
#define ENABLE_WIFI 1
#define ENABLE_LEGACY_WIFI_CLIENT 0
#define ENABLE_HUB_MODE 1
...
enum class Parameter : uint8_t {
    ...
    Effect = 0,
    // Legacy Tab5 encoder order (ENC-A):
...
namespace ParamRange {
    ...
    // Tab5 uses LightwaveOS palette IDs (0..74).
    constexpr uint8_t PALETTE_MAX = 74;
    ...
    constexpr uint8_t ZONE_PALETTE_MAX = 74;
