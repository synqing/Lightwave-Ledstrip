...
static const ParameterDef PARAMETER_TABLE[] = {
    ...
    // Legacy Tab5 order: Effect, Palette, Speed, Mood, Fade, Complexity, Variation, Brightness
    ...
    // PRD: use zones.* only (no legacy zone.*). Runtime send path uses HubState anyway.
    {ParameterId::Zone0Effect, 8,  "zone0Effect", "zones.update",     0,   87,  0},  // 88 effects (0-87)
    {ParameterId::Zone0Speed,  9,  "zone0Speed",  "zones.update",     1,   100, 25}, // Also zone0Palette when toggled
    {ParameterId::Zone1Effect, 10, "zone1Effect", "zones.update",     0,   87,  0},
    {ParameterId::Zone1Speed,  11, "zone1Speed",  "zones.update",     1,   100, 25},
    {ParameterId::Zone2Effect, 12, "zone2Effect", "zones.update",     0,   87,  0},
    {ParameterId::Zone2Speed,  13, "zone2Speed",  "zones.update",     1,   100, 25},
    {ParameterId::Zone3Effect, 14, "zone3Effect", "zones.update",     0,   87,  0},
    {ParameterId::Zone3Speed,  15, "zone3Speed",  "zones.update",     1,   100, 25}
};
