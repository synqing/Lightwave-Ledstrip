...
|-------------|---------|----------|
| esp32dev_audio | `pio run -e esp32dev_audio` | WiFi + WebServer + Audio (default) |
| esp32dev_audio_nowifi | `pio run -e esp32dev_audio_nowifi` | Audio only, no WiFi |
| esp32dev_audio_benchmark | `pio run -e esp32dev_audio_benchmark` | Audio + per-hop timing |
