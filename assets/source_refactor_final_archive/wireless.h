...
// Adding a few more potentially useful headers
#include "lwip/err.h"
#include "lwip/sys.h"
...
void connect_wifi() {
    ...
    // Ensure null termination for SSID
    if (sizeof(wifi_config.sta.ssid) > 0) {
        wifi_config.sta.ssid[sizeof(wifi_config.sta.ssid) - 1] = '\0';
    }

    strncpy((char*)wifi_config.sta.password, wifi_pass, sizeof(wifi_config.sta.password));
    // Ensure null termination for password
    if (sizeof(wifi_config.sta.password) > 0) {
