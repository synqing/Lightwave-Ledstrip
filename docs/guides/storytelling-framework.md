...
stateDiagram-v2
    [*] --> Anticipation
    Anticipation --> BuildUp: Energy rising
    BuildUp --> Climax: Peak intensity
    Climax --> Release: Energy release
    Release --> Resolution: Return to calm
    Resolution --> [*]
    Resolution --> Anticipation: Loop for continuous shows
```
