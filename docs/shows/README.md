...
This flag is typically defined in the `esp32dev_wifi` build environment.
...
2. Build environment mismatch - Use `esp32dev_wifi` environment
...
4. **Rebuild firmware**: `pio run -e esp32dev_wifi -t clean && pio run -e esp32dev_wifi -t upload`
