...
enum class AudioSource : uint8_t {
    ...
    HEAVY_MID, HEAVY_TREBLE,
    AUDIO_CONFIDENCE, LIVELINESS, SILENT_SCALE,
    ONSET_EVENT, KICK_LEVEL, SNARE_LEVEL, HIHAT_LEVEL,
    CHROMA_MAX, CHORD_CONFIDENCE,
    OVERALL_SALIENCY, HARMONIC_SALIENCY, RHYTHMIC_SALIENCY,
    TIMBRAL_SALIENCY, DYNAMIC_SALIENCY,
    BEAT_PULSE, PHRASE_PROGRESS, TENSION, SPECTRAL_BRIGHTNESS,
