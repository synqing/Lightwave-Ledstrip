================================================================================
⚠️  REVISION BANNER — CASE STUDY UPDATED 2026-05-04 PER FORENSIC AUDIT  ⚠️
================================================================================

The "K1 STA failed 6+ times" case study in Section "Real-World Example" of Principle 11 has been REVISED. The original case study was based on a misclassified failure mode. Forensic excavation (`_FORENSIC_WIFI_REPORT.md`) established:

- STA mode actually WORKED in earlier eras (2025-06 Light Crystals; 2025-12 v2 STA-primary).
- The genuine failure was Era 5's Portable Mode AP+STA *concurrent* experiment (2026-02-05 → 2026-02-16, "failed within hours") — the known ESP-IDF 802.11 driver bug.
- The post-failure "AP-only-EVER, STA never worked" doctrine was an over-correction.
- Captain's actual goal-state is dual-mode (AP OR STA, never together).

The REVISED case study (Section "Real-World Example" below) preserves the Principle-11 lesson with the corrected framing: precise constraint scoping matters; over-correction blocks viable architectural directions.

For full historical reconstruction: `docs/tooling/notebooklm-bundles/lightwave_ledstrip/_FORENSIC_WIFI_REPORT.md`.
