 ...
 * ║                                                                    ║
 * ║  WIFI_SSID/WIFI_PASSWORD build flags exist for legacy reasons but  ║
 * ║  K1 does NOT connect to external routers. STA auth fails at the   ║
 * ║  802.11 driver level. See WiFiManager.h and CLAUDE.md.             ║
 * ║  DO NOT add STA logic or change WiFi mode without user approval.   ║
 * ╚══════════════════════════════════════════════════════════════════════╝
 *
