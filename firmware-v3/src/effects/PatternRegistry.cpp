...
const PatternMetadata PATTERN_METADATA[] PROGMEM = {
    ...
    {EID_CROSS_STRIP_WAVE_INTERFERENCE, PM_STR("Cross-Strip Wave Interference"), PatternFamily::INTERFERENCE, PatternTags::CENTER_ORIGIN | PatternTags::DUAL_STRIP | PatternTags::STANDING | PatternTags::PHYSICS, PM_STR("Phase-offset dual-strip standing waves"), PM_STR("3pi/4 default phase offset, dual-channel strip driving"), PM_STR("Beat Pulse (LGP Interference), LGP Wave Collision")}
};
