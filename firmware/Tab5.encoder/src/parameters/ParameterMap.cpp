...
static const ParameterDef PARAMETER_TABLE[] = {
    ...
    {ParameterId::EffectId,   0, "effectId",   "effects.setCurrent", 0,   97,  0},  // Encoder 0: Effect (98 effects 0-97)
    ...
    {ParameterId::Zone0Effect, 8,  "zone0Effect", "zone.setEffect",   0,   97,  0},  // 98 effects (0-97)
    {ParameterId::Zone0Speed,  9,  "zone0Speed",  "zone.setSpeed",    1,   100, 25},  // Also zone0Palette when toggled
    {ParameterId::Zone1Effect, 10, "zone1Effect", "zone.setEffect",   0,   97,  0},  // 98 effects (0-97)
    {ParameterId::Zone1Speed,  11, "zone1Speed",  "zone.setSpeed",    1,   100, 25},  // Also zone1Palette when toggled
    {ParameterId::Zone2Effect, 12, "zone2Effect", "zone.setEffect",   0,   97,  0},  // 98 effects (0-97)
    {ParameterId::Zone2Speed,  13, "zone2Speed",  "zone.setSpeed",    1,   100, 25},  // Also zone2Palette when toggled
    {ParameterId::Zone3Effect, 14, "zone3Effect", "zone.setEffect",   0,   97,  0},  // 98 effects (0-97)
