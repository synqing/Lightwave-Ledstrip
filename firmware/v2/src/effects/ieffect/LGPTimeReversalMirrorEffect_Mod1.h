/**
 * @file LGPTimeReversalMirrorEffect_Mod1.h
 * @brief LGP Time-Reversal Mirror Mod1 - cohesive reverse playback variant
 *
 * Effect ID: 0x1B06 (EID_LGP_TIME_REVERSAL_MIRROR_MOD1)
 * Family: SHOWPIECE_PACK3
 * Category: QUANTUM
 * Tags: CENTER_ORIGIN | DUAL_STRIP | PHYSICS | AUDIO_REACTIVE
 *
 * Design goals vs base effect:
 *   - Remove reverse-end stall by avoiding clamped frame-0 hold
 *   - Improve coherence with interpolated reverse playback
 *   - Reduce edge flashiness with soft edge absorption
 *   - Preserve the sharp "fang" peak character
 *
...
class LGPTimeReversalMirrorEffect_Mod1 : public plugins::IEffect {
public:
    static constexpr lightwaveos::EffectId kId = lightwaveos::EID_LGP_TIME_REVERSAL_MIRROR_MOD1;

    LGPTimeReversalMirrorEffect_Mod1();
    ~LGPTimeReversalMirrorEffect_Mod1() override = default;
