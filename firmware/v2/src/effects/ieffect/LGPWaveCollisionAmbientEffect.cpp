/**
 * @file LGPWaveCollisionAmbientEffect.cpp
...
#include "LGPWaveCollisionAmbientEffect.h"
...
bool LGPWaveCollisionAmbientEffect::init(plugins::EffectContext& ctx) {
    (void)ctx;
    return true;
}

void LGPWaveCollisionAmbientEffect::render(plugins::EffectContext& ctx) {
...
void LGPWaveCollisionAmbientEffect::cleanup() {
    // No resources to free
}

const plugins::EffectMetadata& LGPWaveCollisionAmbientEffect::getMetadata() const {
    static plugins::EffectMetadata meta{
        "LGP Wave Collision (Ambient)",
        "Time-driven colliding wave fronts creating standing nodes",
