...
Effect effects[] = {
    ...
    {"LGP Counter-Propagating", lgpCounterPropagating, EFFECT_TYPE_STANDARD},
    {"LGP Diffraction Grating", lgpDiffractionGrating, EFFECT_TYPE_STANDARD},
    {"LGP Mach-Zehnder", lgpMachZehnder, EFFECT_TYPE_STANDARD},
