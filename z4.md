...
**Drop-in usage (minimum):**

* Allocate `int16_t hannQ15[1536];`
* Call `BuildHannWindowQ15_1536(hannQ15);`
* Use `kHarmonyBins_16k_64` and `kRhythmBins_16k_24` to initialize your two banks.
